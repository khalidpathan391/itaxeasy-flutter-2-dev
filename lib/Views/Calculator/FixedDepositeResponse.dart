...
class FixedDepositResponseUi extends StatefulWidget {
  ...
  ApiResponse<FixedDepositResponse> apiResponse;
  ...
  @override
  _FixedDepositResponseUiState createState() => _FixedDepositResponseUiState();
}
...
class _FixedDepositResponseUiState extends State<FixedDepositResponseUi> {
                            ...
                            child: Card(
                              child: Column(children: [
                                DataTable(
                                    ...
                                    rows: widget.apiResponse.data
                                        .monthlyCalculation.yearlyCalculation
                                        .map((e) {
  ...
  Future<File> generatePDF() async {
    ...
    pdf.addPage(pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Column(children: [
            ...
            pw.Column(
                children: widget
                    .apiResponse.data.monthlyCalculation.yearlyCalculation
                    .map((e) {
              return pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceAround,
                  children: [
    ...
    return PdfApi.saveDocument(name: 'FixedDeposit.pdf', pdf: pdf);
  }
