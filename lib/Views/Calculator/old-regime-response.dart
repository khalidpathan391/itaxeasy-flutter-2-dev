...
class OldRegimeRsoo extends StatefulWidget {
  OldRegimeRsoo({Key key,this.financialYear,this.pan,this.filingCategory,this.residentialStatus,this.basicSalary,this.hraReceived,
    this.rentPaid,this.address,this.otherAllowances,this.interestPaidOnLetOutHpLoan,this.rentReceived,this.propertyTaxPaid,
    this.interestPaidOnSelfOccupiedHpLoan,this.savingsInterest,this.fdInterest,this.dividendIncome,this.otherIncome,
  this.elss,this.nps,this.ppf,this.lic}) : super(key: key);
  ...
  int lic;
  @override
  _OldRegimeRsooState createState() => _OldRegimeRsooState();
}

class _OldRegimeRsooState extends State<OldRegimeRsoo> {
  var insert;
  @override
  void initState() {
    insert = OldRegime(
  ...
  ApiResponse<OldRegimeResponse> apiResponse;
// Map<String,dynamic> obj;
  ...
  getDetails() async{
    ...
    print(insert);
    apiResponse = await apiServices.gstOldRegime(insert);
