...
class PersonalLoanResponseUi extends StatefulWidget {
  ...
  @override
  _PersonalLoanResponseUiState createState() => _PersonalLoanResponseUiState();
}

class _PersonalLoanResponseUiState extends State<PersonalLoanResponseUi> {
  ...
  Future<File> generatePDF() async {
    ...
    return PdfApi.saveDocument(name: 'PersonalLoan.pdf', pdf: pdf);
  }
