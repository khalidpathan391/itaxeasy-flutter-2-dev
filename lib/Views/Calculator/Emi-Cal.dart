...
import 'EmiResponse.dart';

class EmiUI extends StatefulWidget {
  const EmiUI({Key key}) : super(key: key);

  @override
  _EmiUIState createState() => _EmiUIState();
}

class _EmiUIState extends State<EmiUI> {
  ...
  ApiResponse<EmiResponse> _apiResponse;
  var insert;
  ...
  getDetails() async {
    ...
    _apiResponse = await apiServices.emi(insert);
    setState(() {
      isLoading = false;
    });
  }
