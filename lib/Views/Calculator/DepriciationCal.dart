                          ...
                          child: GFButton(
                              ...
                              onPressed: () async {
                                ...
                                if (purchasePrice.text.isEmpty ||
                                    scrapValue.text.isEmpty ||
                                    estimatedUsefulLife.text.isEmpty) {
                                  ...
                                  final insert = DepriciationCal(
                                      purchasePrice:
                                          int.parse(purchasePrice.text),
                                      scrapValue: int.parse(scrapValue.text),
                                      estimatedUsefulLife:
                                          int.parse(estimatedUsefulLife.text));
                                  _apiResponse =
                                      await apiServices.depriciationCal(insert);
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(_apiResponse.data.costOfAsset
                                              .toString()),
                                        ]),
                                  ),
                                );
