...
import 'BusinesssLoanResponse.dart';

class BusinessLoanUI extends StatefulWidget {
  const BusinessLoanUI({Key key}) : super(key: key);

  @override
  _BusinessLoanUIState createState() => _BusinessLoanUIState();
}

class _BusinessLoanUIState extends State<BusinessLoanUI> {
  ...
  ApiResponse<BusinessLoanResponse> _apiResponse;
