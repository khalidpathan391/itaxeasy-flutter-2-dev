...
class BusinessResponseUi extends StatefulWidget {
  BusinessResponseUi({Key key, this.apiResponse}) : super(key: key);

  ApiResponse<BusinessLoanResponse> apiResponse;

  @override
  _BusinessResponseUiState createState() => _BusinessResponseUiState();
}
...
class _BusinessResponseUiState extends State<BusinessResponseUi> {
  ...
  Future<File> generatePDF() async {
    ...
    return PdfApi.saveDocument(name: 'BusinessLoan.pdf', pdf: pdf);
  }
