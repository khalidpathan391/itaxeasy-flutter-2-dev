...
class HomeLoanResponseUi extends StatefulWidget {
  HomeLoanResponseUi({Key key, this.apiResponse}) : super(key: key);
  ApiResponse<HomeLoanResponse> apiResponse;

  @override
  _HomeLoanResponseUiState createState() => _HomeLoanResponseUiState();
}

class _HomeLoanResponseUiState extends State<HomeLoanResponseUi> {
  ...
  Future<File> generatePDF() async {
    ...
    return PdfApi.saveDocument(name: 'HomeLoanEmi.pdf', pdf: pdf);
  }
