...
class AddRecordB2B extends StatefulWidget {
  const AddRecordB2B({Key key}) : super(key: key);

  @override
  State<AddRecordB2B> createState() => _AddRecordB2BState();
}

class _AddRecordB2BState extends State<AddRecordB2B> {
