                  ...
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          "Attach Document(pdf,csv,jpg etc)",
                          style: TextStyle(
                            fontFamily: "Poppins",
                            fontWeight: FontWeight.w500,
                            letterSpacing: 1.5,
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: DropdownButton(
                            ...
                            isExpanded: true,
                            value: prod,
                            items: prodList.map<DropdownMenuItem<String>>((e) {
                              return DropdownMenuItem<String>(
                                child: Text(
                                  e,
                                  style: TextStyle(fontSize: 20),
