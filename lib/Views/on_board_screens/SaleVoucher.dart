...
class SaleVoucher extends StatefulWidget {
  const SaleVoucher({Key key}) : super(key: key);

  @override
  State<SaleVoucher> createState() => _SaleVoucherState();
}

class _SaleVoucherState extends State<SaleVoucher> {
