...
class Challan283 extends StatefulWidget {
  const Challan283({Key key}) : super(key: key);

  @override
  _Challan283State createState() => _Challan283State();
}

class _Challan283State extends State<Challan283> {
  int groupValue = 0;
  int groupValue1 = 0;
  int groupValue2 = 0;
  String dropDown;
