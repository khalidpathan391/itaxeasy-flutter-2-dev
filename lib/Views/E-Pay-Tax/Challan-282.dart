...
class Challan282 extends StatefulWidget {
  const Challan282({Key key}) : super(key: key);

  @override
  _Challan282State createState() => _Challan282State();
}

class _Challan282State extends State<Challan282> {
  int groupValue = 0;
  int groupValue1 = 0;
  int groupValue2 = 0;
  String dropDown;
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Text(
                              "(800) Commodities Transaction Tax",
                              style: TextStyle(
                                fontFamily: "Poppins",
                                fontWeight: FontWeight.w500,
                                letterSpacing: 1.5,
                        ...
                        const Text(
                          "(For Type of Payment 800, Tax Applicable has to be SECURITIES TRANSACTION TAX (0034))",
                          style: TextStyle(
                            fontFamily: "OpenSans",
                            color: Colors.orange,
